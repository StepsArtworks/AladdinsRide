...
function App() {
  ...
  const rugCollectionDetails = {
    ...
    'combined-persian-arabian': {
      name: 'Persian & Arabian Heritage Collections',
      description: 'Experience the finest of both worlds with our combined Persian silk and Arabian cashmere collections, each representing centuries of traditional craftsmanship and artistic excellence.',
      material: 'Silk & Cashmere',
    ...
    '160x230': [
      {
        ...
        size: '160×230 cm',
        images: [
          'https://tbrhub.com/aladdinsride/images/160x230/1.jpg',
          'https://tbrhub.com/aladdinsride/images/160x230/13.jpg'
        ],
        description: 'Discover our finest Persian silk and Arabian cashmere collections, showcasing centuries of traditional craftsmanship.',
        material: 'Silk & Cashmere',
        origin: 'Iran & Saudi Arabia',
        collectionKey: 'combined-persian-arabian',
        productNumber: 'AR-COMBINED'
      }
    ],
    '200x300': [
  ...
  const CollectionView = () => {
    ...
    // Special handling for combined Persian & Arabian collections
    if (viewingCollection === 'combined-persian-arabian') {
      return (
        <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100">
          {/* Navigation Header */}
          <header className="bg-white shadow-lg border-b border-amber-200">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-5xl font-bold text-amber-900 mb-4">
                Persian & Arabian Heritage Collections
              </h1>
              <p className="text-lg text-amber-700 max-w-3xl mx-auto mb-6">
                Experience the finest of both worlds with our combined Persian silk and Arabian cashmere collections, 
                each representing centuries of traditional craftsmanship and artistic excellence.
              </p>
            ...
            <div className="mb-16">
              <div className="text-center mb-8">
                <div className="text-center space-y-4">
                  <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800">Persian Silk Elegance Collection</h2>
                  <p className="text-gray-600 max-w-3xl mx-auto leading-relaxed">
                    Discover the timeless artistry of Persian craftsmanship with our exquisite silk rugs from Iran. 
                    Each piece represents centuries of weaving tradition, featuring intricate patterns and lustrous silk fibers 
                    that create an unparalleled sense of luxury and sophistication.
                  </p>
                </div>
                <div className="flex justify-center space-x-6 text-sm text-amber-600">
                  <div className="flex items-center space-x-2">
                    ...
                    <span>Premium Silk & Cashmere</span>
                  </div>
                  <div className="flex items-center space-x-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {rugCollectionDetails['persian-silk'].rugs.map((rug) => (
                  <div
                    key={rug.id}
                    className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 cursor-pointer border-t-4 border-purple-500"
                    onClick={() => {
                  ...
                  >
                    <div className="aspect-w-4 aspect-h-3 relative overflow-hidden">
                      ...
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-purple-900/20 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300" />
            ...
            <div>
              <div className="text-center mb-8">
                <div className="text-center space-y-4">
                  <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800">Arabian Cashmere Luxury Collection</h2>
                  <p className="text-gray-600 max-w-3xl mx-auto leading-relaxed">
                    Experience the opulent comfort of Arabian luxury with our premium cashmere rugs from Saudi Arabia. 
                    These masterpieces combine traditional Middle Eastern designs with the finest cashmere fibers, 
                    offering unmatched softness and warmth that transforms any space into a sanctuary of elegance.
                  </p>
                </div>
                <div className="flex justify-center space-x-6 text-sm text-amber-600">
                  <div className="flex items-center space-x-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {rugCollectionDetails['arabian-cashmere'].rugs.map((rug) => (
                  <div
                    key={rug.id}
                    className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 cursor-pointer border-t-4 border-amber-500"
                    onClick={() => {
                      setSelectedCollectionRug(rug);
                      setCurrentImageIndex(0);
                      setCurrentView('rug-detail');
              ...
              <button
                ...
                onClickCapture={() => {
                  if (category.id === '120x180') {
                    ...
                    setViewingCollection('combined-persian-arabian');
                    setCurrentView('collection');
